...
For a general introduction to gRPC on Go, see the [official gRPC quickstart](https://grpc.io/docs/languages/csharp/quickstart/).
...
2. Make a ping request:
   ...
   ```sh
   dotnet run -server [RELAY-SERVICE-DOMAIN]:443 -relay -message "Hello Friend"
   ```
